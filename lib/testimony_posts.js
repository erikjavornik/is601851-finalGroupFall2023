...
// Defining the directory path where the testimonies are stored
const testimonyDirectory = path.join(process.cwd(), 'testimonies');

// Function to retrieve information about testimonies
export function getTestimonyFiles() {
    // Reading the file names from the testimony directory synchronously
    ...
    // Returning the array of testimonies
    return testimony;
}
